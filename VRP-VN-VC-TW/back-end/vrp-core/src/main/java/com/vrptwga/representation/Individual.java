...
public class Individual implements Cloneable {
    ...
    public void calculate() {
        ...
        this.totalVTCCost = numberUsedVehicle * 100000;
        this.fitness = this.totalCost + this.totalVTCCost;
    }
    ...
    public String toString() {
        ...
        sb.append(getFitness() == 0 ? "" : ("fitness: " + getFitness() + "\n"));
        return sb.toString();
    }
    ...
    public static Individual optimizeJourneys(Individual individual, OptimizationScenario optimizationScenario) {
        ...
        if (Evaluate.calculateFitness(individualClone) < individual.getFitness())
            return individualClone;
        return individual;
    }
    ...
    public boolean hasSameRoutes(Individual individual) {
        ...
        if (this.getFitness() == individual.getFitness() && this.countRoute() == individual.countRoute())
            return true;
        return false;
    }
    ...
    public static Individual mergeIndividual(List<Individual> individuals) {
        ...
        individual.setFitness(Evaluate.calculateFitness(individual));
        return individual;
    }
