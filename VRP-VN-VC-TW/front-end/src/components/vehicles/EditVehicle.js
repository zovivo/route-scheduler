...
class EditVehicle extends Component {
    ...
    componentDidMount() {
        ...
        goodsGroupsService.search(search).then(response => {
            ...
            this.setState({
                ...
                excludedGoodsGroups: excludedGoodsGroupIds,
            });
        });
    }
    ...
    handleSubmit = () => {
        ...
        let vehicleData = {
            ...
            excludedGoodsGroups: this.state.goodsGroups.filter(goodsGroup => this.state.excludedGoodsGroups.includes(goodsGroup.id)),
        }
