...
export default compose(
    withProps({
        googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyDayLXA1sj_q1ICHo0s3Fc9RKloQXyIE9k",
        // googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyDzbuBm0U__aFwwj0Qi47Id7-0duq-xl8o",
