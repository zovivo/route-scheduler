...
import { listProductCategory, listVehicleType } from '../../../service/utility'
...
class EditVehicle extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            depotId: this.props.editVehicle.depotId,
            available: this.props.editVehicle.available,
            depots: [],
            type: this.props.editVehicle.type,
            excludeCategories: this.props.editVehicle.excludeCategories,
        };
    }
