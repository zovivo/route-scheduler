...
import { getCategories } from '../../../service/utility';
                        ...
                        {(this.state.detailVehicle != null) &&
                            <CCard>
                                <CCardHeader>
                                    ...
                                    <CRow>
                                        <CCol sm='6'>{this.state.detailVehicle.excludedProductCategories.length === 0 ? "" : ("Không chở được hàng: " + getCategories(this.state.detailVehicle.excludedProductCategories))}</CCol>
                                    </CRow>
                                </CCardHeader>
                                <CCardBody>
                                    <CDataTable
