...
import { secondsToHHMMSS } from "../../../service/utility";
                                                            ...
                                                            <CFormGroup row className="my-0">
                                                                ...
                                                                <CCol xs="4">
                                                                    <CFormGroup>
                                                                        ...
                                                                        <CInput id="selectionSize" name="selectionSize" value={this.props.problemAssumption.probMutation} disabled={true} placeholder="selectionSize" type='number' step="1" />
                                                                    </CFormGroup>
                                                                </CCol>
                                                            </CFormGroup>
                                                        </CCardBody>
