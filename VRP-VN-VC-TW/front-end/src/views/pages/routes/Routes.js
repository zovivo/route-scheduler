...
import { checkExistNode, getCustomersOfJourney, getDepotsOfJourney } from "../../../service/utility";
...
export default compose(
    withProps({
        googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyC_zCch4XtM133jgV75SdG5ybkMYu9-LXk",
